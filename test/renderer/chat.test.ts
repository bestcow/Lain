...
describe('filterSlash — 첫 토큰 접두 매칭', () => {
  ...
  it("'/' → 전체 8개", () => {
    expect(filterSlash('/', SLASH_COMMANDS)).toHaveLength(8)
  })
  it("'/zzz' → 없음", () => {
