...
1. Grab the latest `Lain Setup x.y.z.exe` from [Releases](https://github.com/bestcow/Lain/releases/latest) and run it.
2. Once installed, the app checks for and installs updates automatically — no need to come back for new versions.

**Build from source (for developers)** — requires Node.js 20+, Git 2.x+
